...
static __inline void write_index(uint16_t index) {
    CLR_RS;
    palWritePort(GPIOD,(palReadLatch(GPIOD)&0xFFF0)|(index&0x000F));
    palWritePort(GPIOE,(palReadLatch(GPIOE)&0x000F)|(index&0xFFF0));
...
static __inline void write_data(uint16_t data) {
    SET_RS;
    palWritePort(GPIOD,(palReadLatch(GPIOD)&0xFFF0)|(data&0x000F));
    palWritePort(GPIOE,(palReadLatch(GPIOE)&0x000F)|(data&0xFFF0));
...
static __inline uint16_t read_data(void) {
    ...
    value = (palReadPort(GPIOE)&0xFFF0)|(palReadPort(GPIOD)&0x000F);
    SET_RD;
    lcd_lld_delay;
